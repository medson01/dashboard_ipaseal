...
// ***
  ...
  $sub = -($a-$b);
  echo "Houve um acréscimo de <font color='red' size='6'>&nbsp;".$sub."&nbsp;</font> nas CONSULTAS ODONTOLÓGIAS entre os meses de <font color='red' size='6'>&nbsp;".$aa; 
  ...
  if($b < $a){
    $sub = -($a-$b);
  echo "Houve uma redução de <font color='red' size='6'>&nbsp;".$sub."&nbsp;</font> nas CONSULTAS ODONTOLÓGIAS  entre os meses de <font color='red' size='6'>&nbsp;".$aa; 
  $y=$y+1;
  echo "&nbsp;</font> a &nbsp; <font color='red' size='6'>".$bb."</font>";
