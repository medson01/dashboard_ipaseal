...
OR    BE2_CODPRO = '10102019'
OR    BE2_CODPRO LIKE '3%' --> PELE E TECIDO CELULAR SUBCUTÂNEO / CABECA E PESCOSO / MAMAS / SISTEMA) --> VISITA HOSPITALAR (PACIENTE INTERNADO - INTERNAMENTO) 
OR    BE2_CODPRO = '50000012' --> SESSÃO DE PSICOLOGIA
)
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><img src="../imagem/logo.png" width="29" height="27"> IPASEAL SAÚDE</span></a>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a  href="http://10.15.1.10/dashboard_ipaseal2/production/index.php"><i class="fa fa-bar-chart-o"></i> Geral </a>
                  </li>
